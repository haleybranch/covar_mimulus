...
s_d_angle <- (s_pre_d$V2[1]) - (s_peak_d$V2[1])
s_w_angle <- (s_pre_w$V2[1]) - (s_peak_w$V2[1])
c_d_angle <- (c_pre_d$V2[1]) - (c_peak_d$V2[1])
c_w_angle <- (c_pre_w$V2[1]) - (c_peak_w$V2[1])
n_d_angle <- (n_pre_d$V2[1]) - (n_peak_d$V2[1])
n_w_angle <- (n_pre_w$V2[1]) - (n_peak_w$V2[1])

data2 <- data.frame(rbind(s_w_angle, s_d_angle, c_w_angle, c_d_angle, n_w_angle, n_d_angle))
data2$angle <- data2$rbind.s_w_angle..s_d_angle..c_w_angle..c_d_angle..n_w_angle..                  
data2$rbind.s_w_angle..s_d_angle..c_w_angle..c_d_angle..n_w_angle..<-NULL

#write.csv(data2, "Data/angle.csv")
